...
xi.settings.main =
{
    ...
    SERVER_NAME = "Vulcan-FFXI",

    SERVER_MESSAGE =
        "Welcome to the base version of Topaz (Version: %date%)!\n" ..
        "Running on Vulcan Server! Enjoy!\n\n" ..
    ...
    HARVESTING_RATE         = 70, -- % chance to recieve an item from haresting.  Set between 0 and 100.
    EXCAVATION_RATE         = 70, -- % chance to recieve an item from excavation.  Set between 0 and 100.
    LOGGING_RATE            = 70, -- % chance to recieve an item from logging.  Set between 0 and 100.
    MINING_RATE             = 70, -- % chance to recieve an item from mining.  Set between 0 and 100.
    DIGGING_RATE            = 95, -- % chance to receive an item from chocbo digging during favorable weather.  Set between 0 and 100.
    ...
    -- DYNAMIS SETTINGS
    BETWEEN_2DYNA_WAIT_TIME     = 6,        -- Hours before player can re-enter Dynamis. Default is 1 Earthday (24 hours).
